...
@section('title', 'সার্ভিসের রিনিউ এর জন্য আবেদন')
...
@section('content')
    ...
    <div class="container my-lg-5 bg-white rounded">
        <form action="{{ route('frontend.applications.organization-service.update', $application->id) }}" class="row p-3 justify-content-center" method="post">
            {{ method_field('put') }}
            {{ csrf_field() }}
            <div class="col-12">
