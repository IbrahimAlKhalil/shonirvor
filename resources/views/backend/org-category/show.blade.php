                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item h5 mb-0">
                            <a href="{{ route('organization-category.index') }}">ক্যাটাগরি</a>
                        </li>
                                ...
                                <div class="modal fade" id="editModal{{ $key }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('organization-sub-category.update', $subCategory->id) }}" method="post">
                                                {{ csrf_field() }}
                                                {{ method_field('put') }}
                                ...
                                <div class="modal fade" id="deleteModal{{ $key }}" tabindex="-1" role="dialog">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer border-top-0">
                                                <form action="{{ route('organization-sub-category.destroy', $subCategory->id) }}" method="post">
                                                    {{ csrf_field() }}
                                                    {{ method_field('delete') }}
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="list-group">
                            @foreach($navs as $nav)
                                <a href="{{ $nav['url'] }}"
                                   class="list-group-item text-truncate @if($loop->last){{ 'active' }}@endif">
                                    {{ $nav['text'] }}
                                </a>
                            @endforeach
                        </div>
