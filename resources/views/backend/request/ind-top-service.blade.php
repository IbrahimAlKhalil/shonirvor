        ...
        <div class="row justify-content-center">
            <div class="col-md-7 bg-white rounded shadow-sm">
                <div class="row p-5 align-items-center">
                    ...
                    <div class="col-md-3">
                        <img src="{{ asset('storage/' . $application->incomeable->user->photo) }}" alt="{{ $application->incomeable->user->name }}" class="rounded-circle">
                    </div>
                    <div class="col-md-9 h3 pl-4">
                        <a href="#">{{ $application->incomeable->user->name }}</a>
                    </div>
