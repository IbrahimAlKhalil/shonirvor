...
@section('title', 'Create Organizational Service Provider')
            ...
            <div class="col">
                ...
                <form method="post" enctype="multipart/form-data"
                    ...
                    <div class="form-group row">
                        <label for="name" class="col-4 col-form-label">User's Name</label>
                        <div class="col-8">
                    ...
                    <div class="form-group row">
                        <label for="service-mobile" class="col-4 col-form-label">Organization's Mobile Number</label>
                        <div class="col-8">
                            <input id="service-mobile" name="service-mobile" type="number"
                                   value="{{ old('service-mobile') }}"
                                   class="form-control{{ $errors->has('service-mobile') ? ' is-invalid' : '' }}"
                                   required>
                    ...
                    <div class="form-group row">
                        <label for="password" class="col-4 col-form-label">Organization's Password</label>
                        <div class="col-8">
                    ...
                    <div class="form-group row">
                        <label for="email" class="col-4 col-form-label">Organization's Email</label>
                        <div class="col-8">
