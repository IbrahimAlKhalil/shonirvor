...
@section('title', 'সকল বাতিল ব্যক্তিগত সার্ভিস প্রভাইডার')
    ...
    <div class="container">
        <div class="row mt-4">
            <div class="btn-group mx-auto">
                <a href="{{ route('individual-service.disabled') }}" class="btn btn-secondary active">ব্যক্তিগত</a>
        ...
        <div class="row">
            <div class="col-12 mt-4">
                <h4 class="mb-4">সকল বাতিল ব্যক্তিগত সার্ভিস প্রভাইডার</h4>
            </div>
            <div class="col-md-9">
