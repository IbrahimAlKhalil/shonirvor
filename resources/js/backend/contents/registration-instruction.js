...
tinymce.init({
    ...
    plugins: 'advlist colorpicker autoresize legacyoutput media pagebreak toc wordcount anchor hr link save textcolor autolink directionality fullscreen lists noneditable preview searchreplace table textpattern image',
